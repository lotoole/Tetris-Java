 ...
 *
 */
public class Piece7 extends TetrisShape {
		public Piece7(TetrisBoard board) {
			super(board);
			...
			generalShape[3].moveToTetrisLocation(generalShape[0].getX() + 1, generalShape[0].getY());
			for(int i=0; i < generalShape.length; i++){
				generalShape[i].setColor(Color.DARKRED);
